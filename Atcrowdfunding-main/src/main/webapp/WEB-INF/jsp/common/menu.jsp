    ...
    <%-- <c:forEach items="${sessionScope.permissionRoot.children }" var="permission">
        ...
        <ul style="padding-left:0px;" class="list-group">
            ...
            <li class="list-group-item tree-closed">
                ...
                <ul style="margin-top:10px;display:none;">
                    <li style="height:30px;">
                        <a href="${APP_PATH}/cert/toCert.htm"><i class="glyphicon glyphicon-picture"></i> 资质维护</a>
                    </li>
                    <li style="height:30px;">
                    ...
                    <li style="height:30px;">
                        <a href="${APP_PATH}/projecttype/toProject_type.htm"><i class="glyphicon glyphicon-list"></i> 项目分类</a>
                    </li>
                    <li style="height:30px;">
            ...
            <li class="list-group-item tree-closed" >
                <a href="${APP_PATH}/param/toParam.htm"><i class="glyphicon glyphicon-list-alt"></i> 参数管理</a>
            </li>
        </ul>
